...
namespace stinky {
    ...
    application::application(time_frame &&minTimestep) :
            m_IsRunning(false), m_EventController(), m_MinTimestep(std::forward<time_frame>(minTimestep)) {
    }
    ...
    void application::register_event_handlers() {
        ...
        m_EventController.RegisterEventHandler<app_update_event>(
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    void application::push_lLayer(layer *layer) {
