...
namespace stinky {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    fps_camera::fps_camera(uint32_t screenWidth, uint32_t screenHeight, float fov, float zNear, float zFar)
            : camera(glm::perspective(glm::radians(fov), (float) screenWidth / (float) screenHeight, zNear, zFar)),
              perspective_camera_controller(0.09f, 0.8f), m_Yaw(0.0f), m_Pitch(0.0f), m_FocalPoint(0.0f) {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    void fps_camera::set_projection_rh(float fov, float aspectRatio, float zNear, float zFar) {
    ...
    void fps_camera::recalculate_view_projection_matrix() {
        ...
        _M_view_matrix = glm::translate(glm::mat4(1.0f), position) * glm::toMat4(orientation);
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    void fps_camera::pan(const glm::vec3 &oldMousePosition, const glm::vec3 &newMousePosition, const time_frame &ts) {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    void fps_camera::rotate(const glm::vec3 &oldMousePosition, const glm::vec3 &newMousePosition, const time_frame &ts) {
