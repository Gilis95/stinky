...
perspective_camera_controller::perspective_camera_controller(
    ...
    : m_TranslationSpeed(translationSpeed), m_RotationSpeed(rotationSpeed),
      ...
      _M_new_mouse_position(1.0f, 1.0f, 0.0f),
      _M_left_mouse_button_pressed(false),
      _M_middle_mouse_button_pressed(false), m_Rotate(false), m_Pan(false),
      _M_translation_vec(0.0f, 0.0f, 0.0f) {}

/////////////////////////////////////////////////////////////////////////////////////////
perspective_camera_controller::~perspective_camera_controller() = default;

/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::move_left() { --_M_translation_vec.x; }

/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::move_right() { ++_M_translation_vec.x; }

/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::move_up() { --_M_translation_vec.y; }

/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::move_down() { ++_M_translation_vec.y; }

/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::move_near() { --_M_translation_vec.z; }

/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::move_far() { ++_M_translation_vec.z; }

/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::on_update(const time_frame &ts) {
  ZoneScopedN("CameraUpdate") if (_M_translation_vec.x != 0 ||
...
/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::on_keyboard_event(
    const key_pressed_event &event) {
...
void perspective_camera_controller::on_mouse_scrolled(
    const mouse_scrolled_event &event) {
  _M_translation_vec.z += event.y_offset;
  _M_translation_vec.x += event.x_offset;
}

/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::on_mouse_pressed(
    const mouse_button_pressed_event &event) {
...
/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::on_mouse_released(
    const mouse_button_released_event &event) {
  _M_left_mouse_button_pressed =
      event.button != mouse_code::ButtonLeft && _M_left_mouse_button_pressed;
  _M_middle_mouse_button_pressed = event.button != mouse_code::ButtonMiddle &&
                                   _M_middle_mouse_button_pressed;
}

/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::on_mouse_moved(
    const mouse_moved_event &event) {
  if (_M_left_mouse_button_pressed || _M_middle_mouse_button_pressed) {
    ...
    // if button is released frame must be updated according last change, before
...
/////////////////////////////////////////////////////////////////////////////////////////
void perspective_camera_controller::on_window_resize(
    const window_resize_event &event) {
