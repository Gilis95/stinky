...
namespace stinky {
    ...
    public:
        virtual void
        pan(const glm::vec3 &oldMousePosition, const glm::vec3 &newMousePosition, const time_frame &ts) = 0;

        //Camera Rotation
        virtual void
        rotate(const glm::vec3 &oldMousePosition, const glm::vec3 &newMousePosition, const time_frame &ts) = 0;
    ...
    public:
        ...
        void OnMousePressed(const mouse_button_pressed_event &event);
        void OnMouseReleased(const mouse_button_released_event &event);
        void OnMouseMoved(const mouse_moved_event &event);
    ...
    private:
        ...
        bool _M_left_mouse_button_pressed, _M_middle_mouse_button_pressed, m_Rotate, m_Pan;
