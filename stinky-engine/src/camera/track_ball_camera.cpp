...
namespace stinky {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    track_ball_camera::track_ball_camera(uint32_t screen_width, uint32_t screen_height, float fov, float z_near, float z_far)
            : camera(glm::perspective(glm::radians(fov), (float) screen_width / (float) screen_height, z_near, z_far)),
              perspective_camera_controller(0.04f, 0.56f), _M_rotation(1.0, 0.0, 0.0, 0.0), _M_viewport_width(screen_width), _M_viewport_height(screen_height),
              _M_focal_point(0.0f){
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    void track_ball_camera::set_projection_rh(float fov, float aspectRatio, float zNear, float zFar) {
        _M_projection_matrix = glm::perspective(glm::radians(fov), aspectRatio, zNear, zFar);
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    glm::quat track_ball_camera::get_rotation() const {
        return _M_rotation;
    }
    ...
    void track_ball_camera::recalculate_view_projection_matrix() {
        ...
        glm::mat4 translate = glm::translate(-_M_position);
    ...
    void track_ball_camera::recalculate_view_matrix() {
        ...
        _M_view_matrix = glm::translate(glm::mat4(1.0f), position) * glm::toMat4(_M_rotation);
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    void
    track_ball_camera::pan(const glm::vec3 &oldMousePosition, const glm::vec3 &newMousePosition, const time_frame &ts) {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    void
    track_ball_camera::rotate(const glm::vec3 &oldMousePosition, const glm::vec3 &newMousePosition, const time_frame &ts) {
    ...
    void track_ball_camera::translate(const glm::vec3 &delta) {
        auto[xSpeed, ySpeed] = PanSpeed();
        _M_focal_point += -GetRightDirection() * delta.x * 0.3f * xSpeed * _M_distance;
