...
namespace stinky {
    ...
    public:
        explicit track_ball_camera(uint32_t screen_width = 1280, uint32_t screen_height = 720, float fov = 45.0f,
    ...
    public:
        ...
        void pan(const glm::vec3 &oldMousePosition, const glm::vec3 &newMousePosition, const time_frame &ts) override;
        void rotate(const glm::vec3 &oldMousePosition, const glm::vec3 &newMousePosition, const time_frame &ts) override;
