...
namespace stinky {
/**
 * This class represents either certain time point or duration frame between two
 * points. The precision of the class is nanoseconds.
 */
class time_frame {
public:
...
public:
  ...
  /**
   * Subtract given time frame from current, time is clamped in values between 0
   * and 999999999.
   */
