...
public:
  ...
  explicit entity(entt::registry *registry)
      : _M_registry(registry), _M_entity_handle(registry->create()) {}

  /////////////////////////////////////////////////////////////////////////////////////////
  explicit entity(entt::registry *registry, const entt::entity &entt)
      : _M_registry(registry), _M_entity_handle(entt) {}
  ...
  /////////////////////////////////////////////////////////////////////////////////////////
  template <typename T> [[nodiscard]] bool remove_component() {
