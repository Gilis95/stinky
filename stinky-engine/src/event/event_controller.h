...
namespace stinky {
    ...
    namespace event_handlers {
        ...
        template<typename _T_event> std::vector<typename event_handler_container<_T_event>::event_handler_fn>
    ...
    public:
        ...
        void RegisterEventHandler(const typename event_handlers::event_handler_container<_T_event>::event_handler_fn &handler) {
            event_handlers::event_handler_container<_T_event>::container.emplace_back(handler);
        }

        /////////////////////////////////////////////////////////////////////////////////////////
        template<class _T_event>
        void OnEvent(const _T_event &event) {
            std::for_each(
                    ...
                    [&](typename event_handlers::event_handler_container<_T_event>::event_handler_fn &handlerFunction) -> void {
