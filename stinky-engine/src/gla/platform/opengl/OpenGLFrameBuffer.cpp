...
namespace stinky {
    ...
    OpenGLFrameBuffer::OpenGLFrameBuffer(const frame_buffer_specification &spec)
            : frame_buffer(spec), m_RendererID(0), m_ColorAttachment(0), m_DepthAttachment(0) {
        Invalidate();
    }
    ...
    void OpenGLFrameBuffer::Invalidate() {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, _M_specification.width, _M_specification.height, 0,
                     GL_RGB,
